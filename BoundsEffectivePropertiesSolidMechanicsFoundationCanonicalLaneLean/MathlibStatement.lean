import BoundsEffectivePropertiesSolidMechanicsFoundationCanonicalLaneLean.FinalTheorem
...
bounds effective properties endgame pilot. The pilot closes over its admitted class and carries the
...
def theoremSpecificEndgamePilotClosed : Prop :=
  forall A : AdmissibleClass, ConstrainedBoundsEffectivePropertiesClosure A

theorem theorem_specific_endgame_pilot_checked :
    theoremSpecificEndgamePilotClosed := by
  intro A
  exact constrained_bounds_effective_properties_endgame A
